...
const routes = [{ path: '', component: _contact_component__WEBPACK_IMPORTED_MODULE_3__["ContactComponent"] }];
...
/* harmony import */ var _config_regex__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../config/regex */ "./src/app/config/regex.ts");
...
/* harmony import */ var src_app_components_modal_services_modal_controller_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! src/app/components/modal/services/modal-controller.service */ "./src/app/components/modal/services/modal-controller.service.ts");
/* harmony import */ var src_app_components_alert_alert_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! src/app/components/alert/alert.component */ "./src/app/components/alert/alert.component.ts");
...
let ContactComponent = class ContactComponent {
    constructor(form, apiService, modal) {
        this.form = form;
    ...
    createForm() {
        this.contactForm = this.form.group({
            ...
            email: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"](null, [
                _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required,
                _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].maxLength(50),
                _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].pattern(_config_regex__WEBPACK_IMPORTED_MODULE_3__["default"].email)
            ]),
            contactNo: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"](null, [
            ...
            message: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"](null, [
                _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].maxLength(750),
                _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required
            ])
        });
    }
    send() {
        ...
        if (this.contactForm.valid) {
            this.apiService.contactSend(this.contactForm.value)
                .then(_ => this.contactForm.reset())
                .then(_ => this.sent());
        }
    }
    sent() {
        var okay = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
        okay.subscribe(_ => this.modal.close('contact-message-sent-alert'));
        this.modal.create({
    ...
    hasInvalidTouchedDirty(formControlName, error) {
        return this.contactForm.controls[formControlName].invalid
            && (this.contactForm.controls[formControlName].dirty
                || this.contactForm.controls[formControlName].touched)
            && this.contactForm.controls[formControlName].hasError(error);
    }
    goto(url) {
...
/* harmony import */ var _contact_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./contact.component */ "./src/app/modules/contact/contact.component.ts");
