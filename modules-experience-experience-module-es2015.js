...
/* harmony import */ var _experience_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./experience.component */ "./src/app/modules/experience/experience.component.ts");




const routes = [{ path: '', component: _experience_component__WEBPACK_IMPORTED_MODULE_3__["ExperienceComponent"] }];
        ...
        this.timeline = [
            {
                ...
                moreDescriptions: [
                    'Participate on back office web platform development',
                    'Involved in revamping web applications to improve business solutions and migrate technical solutions, from MVC to Blazor Web Assembly.',
                    'Create common components using Razor Class Library, Blazor components, existing Javascript libraries etc.',
                    'Developed working proof of concepts to solve technical problems such as real-time data transfer (SignalR), authentication (JWT), Hangfire etc.',
                    'Integrate third party Restful APIs such Grab Web Pay.'
                ],
                keypoint: {
                    label: 'Technologies',
            ...
            },
            {
                ...
                moreDescriptions: [
                    'Gathering business requirements and creating technical solutions.',
                    'Creating or participating in creation of UI prototypes from technical solutions.',
                    'Developing application from front-end to backend.',
                    'Designing database table structure.',
                    'Collaborating with the team on researching and applying necessary updates in technologies, tools, practices, patterns, and other development related resources.',
            ...
            },
            {
                ...
                moreDescriptions: [
                    'Involved in development of new projects and maintenance of existing projects.',
                    'Involved in collaboration of UI/UX standards components.',
                    'Participated in estimation of work items in team sprint planning.',
                    'Involved in maintenance of existing project from third-party team.'
                ],
                keypoint: {
                    label: 'Technologies',
            ...
            },
            {
                ...
                moreDescriptions: [
                    'Involved in development of website and web admin of the company.',
                    'Researched for open-source or less expensive way of development to reduce company expense.',
                    'Involved in development of cross-platform mobile application.',
                    'Involved in converting wireframes designs into UI components.',
                    'Setup pipelines for CI/CD.'
                ],
                keypoint: {
                    label: 'Technologies',
...
//# sourceMappingURL=modules-experience-experience-module-es2015.js.map